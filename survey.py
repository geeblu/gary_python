...
if drink_with_friend == "y":
    ...
    drink_with_friend = "whenever"
    print("I guess your undecided")

print(f"My name is {name} and I am {age} old, My gender is {gender}, I live in the state of {state}. I like {drink}, and I like to drink {drink_with_friend}")
